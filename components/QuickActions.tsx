...
export default function QuickActions() {
  const actions: Action[] = [
    { label: "Productos",  href: "/catalog",   icon: Tag,      color: "text-orange-600 dark:text-orange-400", bg: "bg-orange-100 dark:bg-orange-900/30 group-hover:bg-orange-200 dark:group-hover:bg-orange-900/50" },
